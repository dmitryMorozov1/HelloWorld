...
export default {
  data() {
    return {
       peoples: [
          { id: '1', name: 'Володя Говядко', link: '/Володя', sub: true, sig: true, img: "http://memesmix.net/media/created/m6tnhm.jpg"},
          ...
          { id: '4', name: 'Лиза Говядко', link: '/Лизасиськи', sub: false, sig: false, img: "http://www.ivoirebusiness.net/sites/default/files/poutine%20vladi_0.jpg"},
