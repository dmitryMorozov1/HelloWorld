...
<script>
import Question from './questionWithComment.vue';
    ...
    this.questions = [
      {
        ...
        comment: { id: '1', 
                   ...
                   likes: '11111', 
                   dislikes: '22222', 
                   label: 'ВНИМАНИЕ\n\nЭТО мой коммент, так ч asdsadgfsdf dds sads safd e asdsd sadsa dsad sads awedsad sads a\n\nА тут текст в одной строке\n\ndsa sads ads sd sadsa dsad sadsadsdsdто всем молчать\nя сказал adsd asdsa dsad asdddd s s ss sdasd', 
      ...
      },
      {
        ...
        comment: { id: '123', 
                   ...
                   likes: '1', 
                   dislikes: '0', 
                   label: 'А это огромный коммент... \n\nsdfdf dfds ВВВВВВ В В В ВВВЫВОЛЫРВЫЛВРЫШГВП ЫЛНВ ПЫВНЫП ВЛОЫ ПВЫЛРВП ЫВЛПЫВ РЫПВЫ ВПЫДВ ОЛЫПВРД ЫВПЫ ОРВЫВО Ыf dsf dsfds\nf fsd dsfddsf sdfdsf dsasdgf hfdgdsfsdfgshfgsdfdsgfdgdkslfyhdsufkjgdflaskfhsdklffh dfh doifh d;fdfs;dlhdsfhf ofh dg;sglhdfg sdkhf dlfhd flsdhg ldsfj dfihdsifodshg idshg;dslfdhsf;sdlfk sdfhsdf sdf sd;lgkhfjgkldhlf jdfh dghrgi dshfdskf lhdsfks djf sdflisdjf sdlfk sdfesoigh ;fgsdsdfdf dfds fdsf dfd sfsdf dsf dsfds\nf fsd dsfddsf sdfdsf dsasdgf hfdgdsfsdfgshfgsdfdsgfdgdkslfyhdsufkjgdflaskfhsdklffh dfh doifh d;fdfs;dlhdsfhf ofh dg;sglhdfg sdkhf dlfhd flsdhg ldsfj dfihdsifodshg idshg;dslfdhsf;sdlfk sdfhsdf sdf sd;lgkhfjgkldhlf jdfh dghrgi dshfdskf lhdsfks djf sdflisdjf sdlfk sdfesoigh ;fgsdsdfdf dfds fdsf dfd sfsdf dsf dsfds\nf fsd dsfddsf sdfdsf dsasdgf hfdgdsfsdfgshfgsdfdsgfdgdkslfyhdsufkjgdflaskfhsdklffh dfh doifh d;fdfs;dlhdsfhf ofh dg;sglhdfg sdkhf dlfhd flsdhg ldsfj dfihdsifodshg idshg;dslfdhsf;sdlfk sdfhsdf sdf sd;lgkhfjgkldhlf jdfh dghrgi dshfdskf lhdsfks djf sdflisdjf sdlfk sdfesoigh ;fgsdsdfdf dfds fdsf dfd sfsdf dsf dsfds\nf fsd dsfddsf sdfdsf dsasdgf hfdgdsfsdfgshfgsdfdsgfdgdkslfyhdsufkjgdflaskfhsdklffh dfh doifh d;fdfs;dlhdsfhf ofh dg;sglhdfg sdkhf dlfhd flsdhg ldsfj dfihdsifodshg idshg;dslfdhsf;sdlfk sdfhsdf sdf sd;lgkhfjgkldhlf jdfh dghrgi dshfdskf lhdsfks djf sdflisdjf sdlfk sdfesoigh ;fgsd', 
                   date: '2018-04-22T23:33:00Z', 
                   img: "http://memesmix.net/media/created/m6tnhm.jpg"
        },
        ownerName: 'Елизавета Седова',
      ...
      },
      {
        ...
        comment: { id: '33', 
                   ...
                   likes: '1', 
                   dislikes: '0', 
                   label: 'ВНИМАНИЕ\n\nЭТО мой коммент, так что всем молчать\nя сказал', 
                   date: '2018-04-22T23:33:00Z', 
                   img: "http://memesmix.net/media/created/m6tnhm.jpg"
        },
        ownerName: 'Елизавета Седова',
      ...
      },
      {
        ...
        comment: { id: '12', 
                   ...
                   likes: '1', 
                   dislikes: '0', 
                   label: 'ВНИМАНИЕ ЭТО мой коммент, так что всем молчатья сказал', 
                   date: '2018-04-22T23:33:00Z', 
                   img: "http://memesmix.net/media/created/m6tnhm.jpg"
        },
        ownerName: 'Елизавета Седова',
