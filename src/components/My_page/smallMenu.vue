        ...
        <v-card class="pa-2">
            ...
            <v-flex class="ml-2">
              ...
              <v-layout justify-left column v-for="problem in problems" :key="problem.id">
                <v-layout row>
                  <v-checkbox color="blue" class="check" hide-details v-model="problem.checked" style="max-width: 30px;"></v-checkbox>
                  <v-layout justify-left class="med-16 pointer" @click="problem.checked=!problem.checked">{{problem.name}}</v-layout>
                </v-layout>
              </v-layout>
            </v-flex>
